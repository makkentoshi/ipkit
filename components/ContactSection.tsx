...
const ContactSection = React.forwardRef<HTMLDivElement>((props, ref) => (
  <section
    className=" py-[12rem] bg-gradient-to-b from-[#0A0A1F]/50 to-[#141428]/50 backdrop-blur-sm"
    ref={ref}
  >
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="space-y-8">
          <div>
            <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-pink-400">
              ЗАКАЗАТЬ УСЛУГИ
            </h2>
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-semibold text-blue-300">КОНТАКТЫ</h3>
            <div className="space-y-4">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg px-6 py-3 font-semibold hover:opacity-90 transition-opacity"
            >
              Отправить
            </button>
          </form>
